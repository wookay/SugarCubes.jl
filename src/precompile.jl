...
precompile(Tuple{Type{SugarCubes.CodeBlock}, String, String, Nothing})
...
precompile(Tuple{typeof(SugarCubes.get_func_block_range), SugarCubes.CodeBlock, SugarCubes.Signature})
precompile(Tuple{typeof(SugarCubes.get_func_block_range), SugarCubes.CodeBlock, Nothing})
precompile(Tuple{typeof(SugarCubes.get_func_block_range), SugarCubes.CodeBlock})
...
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:filepath, :signature), Tuple{String, Nothing}}, typeof(SugarCubes.code_block_with)})
precompile(Tuple{Type{NamedTuple{(:filepath, :signature), T} where T<:Tuple}, Tuple{String, Expr}})
precompile(Tuple{Type{NamedTuple{(:filepath, :signature), T} where T<:Tuple}, Tuple{String, Nothing}})
