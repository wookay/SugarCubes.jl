module test_sugarcubes_femtocompier_typeinf_local
...
@test src_block.signature == remove_linenums_in_macrocall!(:(function typeinf_local(interp::AbstractInterpreter, frame::InferenceState, nextresult::CurrentState) end))
...
end # module test_sugarcubes_femtocompier_typeinf_local
